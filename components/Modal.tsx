              ...
              >
                ...
                <div className='mt-2'>
                  <input
                    ...
                    className='w-full border border-gray-300 rounded-mn outline-none p-5'
                  ></input>
                </div>
                ...
                <div>
                  <button
                    ...
                    className='w-full border border-gray-399 rounded-md outline-none p-5 focus-visible:ring-2
